...
public class TravelClaim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        travelDetails = (EditText) findViewById(R.id.TravelDetailsClaim);
        policyNumberSpinner = (Spinner) findViewById(R.id.Spinner_PolicyNumber_TravelClaim) ;
                ...
                if (putData.startPut()) {
                    if (putData.onComplete()) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(TravelClaim.this, R.layout.listitem_carcliam_policynumber, items);
        ...
        travelClaim = (Button) findViewById(R.id.GetTravelClaim);
        travelClaim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Details = travelDetails.getText().toString();
                if ( !Details.equals("")) {
                    Intent intent = new Intent(TravelClaim.this, SuccessfullyClaim.class);
                    startActivity(intent);
                }else{
                    AlertDialog.Builder mess =  new AlertDialog.Builder(TravelClaim.this);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            this.startActivity(new Intent(TravelClaim.this,MainActivity.class));
